...
Register.addEventListener('click', ()=>{
     if(document.getElementById('UserCreate').style.display){
          ...
          if(!FullName || !Email || !Tel || !Password || !CPassword){
          document.getElementById('RError').textContent = `Please Fill In All The Spaces`;
          }else{
               if(Password == CPassword){
                    if(confirm(`Please verify the information you provided, if they are all correct press Ok, else press cancel to edit \r\n \r\n Name: ${FullName} \r\n Email: ${Email} \r\n Tel: ${Tel} \r\n Password: ${Password}`)){
                         ...
                         document.getElementById('RError').textContent = `Edit your inputs`;
                    }
                         }else{
